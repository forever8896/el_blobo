...
export default function Home() {
  ...
  useEffect(() => {
    ...
    }).to(text1Ref.current, { opacity: 1, duration: 0 })
      .to(text1Ref.current, { opacity: 0, duration: 1.0, delay: 0.5 })
    .to(text2Ref.current, { opacity: 1, duration: 1.5, delay: 0.5 }); 
  ...
  return (
    <div className="fixed inset-0 bg-black flex items-center justify-center overflow-hidden">
      ...
      {/* Text Container - 2/3rds down the page (top-2/3) */}
