...
contract DeployMain is Script {
    function run() external {
        ...
        // ---------------------------------------------------------------------
        // If ProjectRegistry has constructor args, adjust this line.
        // Owner will be msg.sender (the deployer) inside the constructor.
        ProjectRegistry registry = new ProjectRegistry(registryOwner);

        // (Optional sanity check: registryOwner is expected to equal deployer)
